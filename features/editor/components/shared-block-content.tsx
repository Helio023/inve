...
export const SharedBlockContent = (props: SharedProps) => {
  ...
  switch (block.type) {
    ...
    case "TEXT":
      ...
      return <TextBlock block={normalizedBlock} styles={s} />;

    case "IMAGE":
      return <ImageBlock block={normalizedBlock} styles={s} />;

    case "VIDEO":
      return <VideoBlock block={normalizedBlock} styles={s} />;

    case "MAP":
      return <MapBlock content={block.content} styles={s} isPreview={isPreview} />;
    ...
    case "BUTTON":
      return <ButtonBlock content={block.content} styles={s} isPreview={isPreview} />;
    ...
    case "SONG_REQUEST":
      return <SongRequestBlock content={block.content} styles={s} isPreview={isPreview} />;

    case "SAVE_THE_DATE":
      return <SaveTheDateRenderer content={block.content} styles={s} isPreview={isPreview} />;
   ...
   case "RSVP":
    ...
    case "MENU":
      return <MenuRenderer content={block.content} styles={s} isPreview={isPreview} />;
    ...
    case "COLUMNS":
      return (
        <div
          className={cn(
            "grid gap-4 w-full transition-all",
            !isPreview && !s.backgroundColor && "bg-slate-50/10 border border-dashed border-slate-200"
          )}
          style={{
            gridTemplateColumns: `repeat(${block.content.cols || 1}, minmax(0, 1fr))`,
            padding: "0px",
