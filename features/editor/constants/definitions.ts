...
//         controls: ["typography", "colors"],
//       },
//         { id: "location", label: "Local", icon: MapPin, controls: ["typography", "colors"] },
//       { id: "speaker", label: "Responsável", icon: User, controls: ["typography", "colors"] },
//       { id: "desc", label: "Descrições", icon: AlignLeft, controls: ["typography", "colors"] },
//     ],
//   },
//   MENU: {
//     label: "Menu",
