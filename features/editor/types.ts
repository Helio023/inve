...
// // Tipo específico para as animações
...
// --- ALTERAÇÃO AQUI ---
// Adicionado um tipo para os estilos de borda, para maior controlo e segurança.
...
export const DEFAULT_STYLES = {
  ...
  // --- ALTERAÇÃO AQUI ---
  // Adicionado `borderStyle` para permitir a escolha do tipo de borda.
  borderWidth: 0,
