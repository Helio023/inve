      ...
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-2 font-bold text-lg text-slate-900">
            <Sparkles className="w-5 h-5 text-blue-600" /> Invite SaaS
          </div>
          <p className="text-sm text-slate-500 leading-relaxed">
            A plataforma líder em Moçambique para criação e gestão de convites digitais profissionais.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-slate-600">
            ...
            <li><Link href="#pricing" className="hover:text-blue-600">Preços</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-slate-600">
            <li><Link href="/terms" className="hover:text-blue-600">Termos de Uso</Link></li>
            <li><Link href="/privacy" className="hover:text-blue-600">Privacidade</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p className="text-sm text-slate-600 mb-2">suporte@invitesaas.co.mz</p>
